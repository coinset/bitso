...
await build({
  ...
  package: {
    ...
    description: "Universal Bitso API client",
    license: "MIT",
    sideEffects: false,
    "publishConfig": {
      "access": "public",
    ...
    repository: {
      type: "git",
      url: "https://github.com/coinset/bitso.git",
    },
    bugs: {
      url: "https://github.com/coinset/bitso/issues",
    },
    homepage: "https://github.com/coinset/bitso#readme",
    funding: {
      type: "patreon",
